...
function(check_cacheline_alignment)
    ...
    if (NOT DESTRUCTIVE_SIZE STREQUAL REAL_CACHELINE_SIZE OR NOT CONSTRUCTIVE_SIZE STREQUAL REAL_CACHELINE_SIZE)
        ...
        if (AIPP_FORCE_CHANGE_GCC_CACHE_SIZES)
    ...
    if (NOT ${AIPP_CACHE_LINE_SIZE} EQUAL ${REAL_CACHELINE_SIZE})
        message(FATAL_ERROR "AIPP_CACHE_LINE_SIZE=${AIPP_CACHE_LINE_SIZE}"
                " does not match REAL_CACHELINE_SIZE=${REAL_CACHELINE_SIZE}"
        )
    endif ()
endfunction()

function(create_aipp_compile_options_target)
    add_library(aipp_compile_options INTERFACE)
    ...
    target_compile_options(aipp_compile_options INTERFACE -Werror ${WARNINGS})

    check_cacheline_alignment()
    if (${AIPP_CACHE_LINE_SIZE})
        target_compile_definitions(aipp_compile_options INTERFACE
                AIPP_CACHE_LINE_SIZE=${AIPP_CACHE_LINE_SIZE})
    endif ()
